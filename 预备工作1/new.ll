...
7:                                                ; preds = %42, %0
  ...
  ; 利用slt 判断循环条件i<10是否符合
  %9 = icmp slt i32 %8, 10
  ; 符合则跳转到label10  否则跳转至label45结束循环
  br i1 %9, label %10, label %45

10:                                               ; preds = %7
  ; （循环条件符合）开始循环体部分
  %11 = load i32, i32* %5, align 4
  ; sitofp 将有符号整型i转换为浮点数
  %12 = sitofp i32 %11 to float
  %13 = load i32, i32* %5, align 4
  %14 = sext i32 %13 to i64
  %15 = getelementptr inbounds [10 x float], [10 x float]* %1, i64 0, i64 %14
  ; a[i]=i
  ...
  %25 = getelementptr inbounds [10 x float], [10 x float]* %1, i64 0, i64 %24
  ; load a[i]到%26
  ...
  ; 条件成立，跳转至label%33 否则跳转至label%41
...
33:                                               ; preds = %10
  ...
  %36 = getelementptr inbounds [10 x float], [10 x float]* %1, i64 0, i64 %35
  ; a[i]=-1
